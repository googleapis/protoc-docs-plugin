...
from protoc_docs.models import descriptor_pb2 as descriptor__pb2
...
_CODEGENERATORREQUEST.fields_by_name['proto_file'].message_type = descriptor__pb2._FILEDESCRIPTORPROTO
